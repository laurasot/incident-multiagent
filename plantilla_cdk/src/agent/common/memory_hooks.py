...
class SupervisorMemoryHooks:
    ...
    def __init__(self):
        ...
        # Memory IDs from environment variables (set by CDK)
        self.short_term_memory_id = os.environ.get("SHORT_TERM_MEMORY_ID")
        self.long_term_incidents_memory_id = os.environ.get("LONG_TERM_INCIDENTS_MEMORY_ID")
        self.long_term_resolutions_memory_id = os.environ.get("LONG_TERM_RESOLUTIONS_MEMORY_ID")
